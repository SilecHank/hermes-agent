...
_SESSION_IVD_ADMIN: ContextVar = ContextVar("HERMES_SESSION_IVD_ADMIN", default=_UNSET)
...
_VAR_MAP = {
    ...
    "HERMES_SESSION_IVD_ADMIN": _SESSION_IVD_ADMIN,
...
def set_session_vars(
    ...
    tokens = [
        ...
        _SESSION_IVD_ADMIN.set("1" if ivd_admin else ""),
