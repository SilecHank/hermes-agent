...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("ivd", "Run or inspect the shared IVD maintenance command bus",
               "Tools & Skills", gateway_only=True,
               args_hint="[sync|status] [--scope name]",
...
#   - version: informational command; kept behind /hermes at Slack's 50-command cap.
